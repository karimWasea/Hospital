...
{
    public class RegisterModelpatient : PageModel
    {
        ...
        Imgoeration _imgoeration;

        public RegisterModelpatient(
            UserManager<ApplicationUser> userManager,
            IUserStore<ApplicationUser> userStore,
            SignInManager<ApplicationUser> signInManager,
            ILogger<RegisterModel> logger,
            IEmailSender emailSender,
            IWebHostEnvironment webHostEnvironment, Imgoeration imgoeration)
        {
        ...
        public class InputModel
        {
            ...
            //public required RoleRegeseter RoleRegeseter { get; set; }
            public  required string Nationality { get; set; }

            public  required IFormFile imphgurl { get; set; }

            public required string PostalCode { get; set; }
            public  required string Phonnumber { get; set; }

            public required DateTime dateofbarth { get; set; }
        ...
        //public List<SelectListItem> Rolergester { get; set; }
        public List<SelectListItem> spicialist { get; set; }
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            //Rolergester = Enum.GetValues(typeof(RoleRegeseter))
            //            .Cast<RoleRegeseter>()
            //            .Select(role => new SelectListItem
            //            {
            //                Value = ((byte)role).ToString(),
            //                Text = role.ToString()
            //            })
            //            .ToList();

            //spicialist = Enum.GetValues(typeof(spicialist))
            //            .Cast<Department>()
            //            .Select(Dept => new SelectListItem
            //            {
            //                Value = ((byte)Dept).ToString(),
            //                Text = Dept.ToString()
            //            })
            //            .ToList();
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.RoleRegeseter = RoleRegeseter.Patient;
